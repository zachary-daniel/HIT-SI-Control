clear; close all; clc;
function [data] = create_shot_data(shot) %pass in shot as form "shot#.hdf5", data is returned in order of state space variable number (x1,x2,x3), then (x1dot,x2dot,x3dot). Time is first col i_tor is last col
...
data = [time,i_L1_1,v_cap_1,i_fcoil_1,v_L1_1,i_cap_1,v_fcoil_1,i_L1_2,v_cap_2,i_fcoil_2,v_L1_2,i_cap_2,v_fcoil_2,
