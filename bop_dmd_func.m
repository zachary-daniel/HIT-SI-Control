function [w_kmeans,e_kmeans,b_avg,atilde,flag] = bop_dmd_func(num_trials, data,trial_size,rank,imode,train_time,maxiter) %If nothing is passed to trial size, then the default for trial_size = .2
